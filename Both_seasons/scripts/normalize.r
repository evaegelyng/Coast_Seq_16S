...
###Load OTU table
otu_tab<-read.table("~/eDNA/faststorage/Velux/CoastSequence/Autumn/Gua18s/both_seasons/ncbi_nt_tax/results/COSQ_Curated_LULU_95.tsv", sep="\t", header=T, row.names=1,check.names=F)
...
### Save table
write.table(otu_tab_trans,"otu_rel_hel.txt", sep="\t", row.names=TRUE)
