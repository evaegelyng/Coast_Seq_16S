...
otu_mat<-as.matrix(read.table("otu_silva.txt", sep="\t", header=T, row.names=1,check.names=F))
...
setwd("/home/mpavila/eDNA/faststorage/Velux/CoastSequence/Autumn/Bac16s/both_silva/results/cleanup_ASV_wise/spring")
...
setwd("/home/mpavila/eDNA/faststorage/Velux/CoastSequence/Autumn/Bac16s/both_silva/results/cleanup_ASV_wise/autumn")
